...
public:
	...
	void postCastSpell(Player* player, SpellModyficator& spellModyficator, bool finishedCast = true,
...
protected:
	bool playerSpellCheck(Player* player, SpellModyficator& spellModyficator) const;
