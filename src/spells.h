...
public:
	...
	void postCastSpell(Player* player, SpellModyficator& spellModifier, bool finishedCast = true,
...
protected:
	bool playerSpellCheck(Player* player, SpellModyficator& spellModifier) const;
