...
enum ConditionParam_t
{
	...
	CONDITION_PARAM_SELLMODIFIER_ID = 57,
	CONDITION_PARAM_SELLMODIFIER_LEVEL = 58,
	CONDITION_PARAM_SELLMODIFIER_MAGICLEVEL = 59,
	CONDITION_PARAM_SELLMODIFIER_MANACOST = 60,
	CONDITION_PARAM_SELLMODIFIER_COOLDOWN = 61,
	CONDITION_PARAM_SELLMODIFIER_BOOSTDAMAGE = 62,
};
